...
const Navbar = () => {
    ...
    <>
     {/* find canditates */}
                    <li>
                        <a className='hover:bg-[#52B4DA63] flex rounded-xl py-5 manrope-font font-semibold text-[14px] text-[#E1E3F2CC]'>
                    ...
                    {/* your job posts */}
                    <li>
                        <a className="hover:bg-[#52B4DA63] rounded-xl py-5 px-3 manrope-font font-semibold text-[14px] text-[#E1E3F2CC]">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="bg-[#52B4DA63] ml-8 rounded-full w-5 h-5 flex items-center justify-center text-xs">
                                    8
                                </div>
                            </div>
                        </a>
